...
H.apply_colorscheme = function(config)
  ...
  hi('SpellBad',       { fg=p.red,     bg=nil,       sp=p.red,    undercurl=true })
  hi('SpellCap',       { fg=p.cyan,    bg=nil,       sp=p.cyan,   undercurl=true })
  hi('SpellLocal',     { fg=p.yellow,  bg=nil,       sp=p.yellow, undercurl=true })
  hi('SpellRare',      { fg=p.blue,    bg=nil,       sp=p.blue,   undercurl=true })
